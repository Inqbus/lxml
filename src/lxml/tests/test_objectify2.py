...
class ObjectifyTestCase(HelperTestCase):
    ...
    def test_child(self):
        ...
        self.assertEqual("0", root.obj_c1.c2.text)
    ...
    def test_child_getattr_empty_ns(self):
        ...
        self.assertEqual("0", getattr(root.obj_c1, "c2").text)
    ...
    def test_addattr_list(self):
        ...
        root.addattr("obj_c1", list(new_el.a))
    ...
    def test_child_addattr(self):
        root = self.XML(xml_str)
        self.assertEqual(3, len(root.obj_c1.c2))
        root.obj_c1.addattr("c2", 3)
        self.assertEqual(4, len(root.obj_c1.c2))
        self.assertEqual("3", root.obj_c1.c2[3].text)

    def test_child_index(self):
        root = self.XML(xml_str)
        self.assertEqual("0", root.obj_c1.c2[0].text)
        self.assertEqual("1", root.obj_c1.c2[1].text)
        self.assertEqual("2", root.obj_c1.c2[2].text)
        self.assertRaises(IndexError, operator.getitem, root.obj_c1.c2, 3)
    ...
    def test_child_index_neg(self):
        root = self.XML(xml_str)
        self.assertEqual("0", root.obj_c1.c2[0].text)
        self.assertEqual("0", root.obj_c1.c2[-3].text)
        self.assertEqual("1", root.obj_c1.c2[-2].text)
        self.assertEqual("2", root.obj_c1.c2[-1].text)
        self.assertRaises(IndexError, operator.getitem, root.obj_c1.c2, -4)
    ...
    def test_child_iter(self):
        ...
        self.assertEqual([root.obj_c1.c2[0], root.obj_c1.c2[1], root.obj_c1.c2[2]],
                         list(iter(root.obj_c1.c2)))

    def test_class_lookup(self):
        root = self.XML(xml_str)
        self.assertTrue(isinstance(root.obj_c1.c2, objectify.ObjectifiedElement))
    ...
    def test_dir(self):
        ...
        self.assertEqual(dir_c2, dir(root.obj_c1))

    def test_vars(self):
        root = self.XML(xml_str)
        self.assertEqual({'c1' : root.obj_c1},    vars(root))
        self.assertEqual({'c2' : root.obj_c1.c2}, vars(root.obj_c1))

    def test_child_set_ro(self):
        root = self.XML(xml_str)
        self.assertRaises(TypeError, setattr, root.obj_c1.c2, 'text',  "test")
        self.assertRaises(TypeError, setattr, root.obj_c1.c2, 'pyval', "test")
    ...
    def test_object_path(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( "root.obj_c1.c2" )
        self.assertEqual(root.obj_c1.c2.text, path.find(root).text)
        self.assertEqual(root.obj_c1.c2.text, path(root).text)
    ...
    def test_object_path_fail(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( "root.obj_c1.c99" )
    ...
    def test_object_path_default_relative(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( ".obj_c1.c99" )
        self.assertEqual(None, path(root, None))
    ...
    def test_object_path_hasattr(self):
        ...
        path = objectify.ObjectPath( "root.obj_c1" )
        self.assertTrue(path.hasattr(root))
        path = objectify.ObjectPath( "root.obj_c1.c2" )
        self.assertTrue(path.hasattr(root))
        path = objectify.ObjectPath( "root.obj_c1.{otherNS}c2" )
        self.assertTrue(path.hasattr(root))
        path = objectify.ObjectPath( "root.obj_c1.c2[1]" )
        self.assertTrue(path.hasattr(root))
        path = objectify.ObjectPath( "root.obj_c1.c2[2]" )
        self.assertTrue(path.hasattr(root))
        path = objectify.ObjectPath( "root.obj_c1.c2[3]" )
        self.assertFalse(path.hasattr(root))
        path = objectify.ObjectPath( "root.obj_c1[1].c2" )
        self.assertFalse(path.hasattr(root))

    def test_object_path_dot(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( "." )
        self.assertEqual(root.obj_c1.c2.text, path(root).obj_c1.c2.text)
    ...
    def test_object_path_dot_root(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( ".obj_c1.c2" )
        self.assertEqual(root.obj_c1.c2.text, path(root).text)
    ...
    def test_object_path_index(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( "root.obj_c1[0].c2[0]" )
        self.assertEqual(root.obj_c1.c2.text, path(root).text)

        path = objectify.ObjectPath( "root.obj_c1[0].c2" )
        self.assertEqual(root.obj_c1.c2.text, path(root).text)

        path = objectify.ObjectPath( "root.obj_c1[0].c2[1]" )
        self.assertEqual(root.obj_c1.c2[1].text, path(root).text)

        path = objectify.ObjectPath( "root.obj_c1.c2[2]" )
        self.assertEqual(root.obj_c1.c2[2].text, path(root).text)

        path = objectify.ObjectPath( "root.obj_c1.c2[-1]" )
        self.assertEqual(root.obj_c1.c2[-1].text, path(root).text)

        path = objectify.ObjectPath( "root.obj_c1.c2[-3]" )
        self.assertEqual(root.obj_c1.c2[-3].text, path(root).text)
    ...
    def test_object_path_index_fail_lookup(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath("root.obj_c1[9999].c2")
        self.assertRaises(AttributeError, path, root)

        path = objectify.ObjectPath("root.obj_c1[0].c2[9999]")
        self.assertRaises(AttributeError, path, root)

        path = objectify.ObjectPath(".obj_c1[9999].c2[0]")
        self.assertRaises(AttributeError, path, root)

        path = objectify.ObjectPath("root.obj_c1[-2].c2")
        self.assertRaises(AttributeError, path, root)

        path = objectify.ObjectPath("root.obj_c1[0].c2[-4]")
        self.assertRaises(AttributeError, path, root)

    def test_object_path_ns(self):
        root = self.XML(xml_str)
        path = objectify.ObjectPath( "{objectified}root.obj_c1.c2" )
        self.assertEqual(root.obj_c1.c2.text, path.find(root).text)
        path = objectify.ObjectPath( "{objectified}root.{objectified}c1.c2" )
        self.assertEqual(root.obj_c1.c2.text, path.find(root).text)
        path = objectify.ObjectPath( "root.{objectified}c1.{objectified}c2" )
        self.assertEqual(root.obj_c1.c2.text, path.find(root).text)
        path = objectify.ObjectPath( "root.obj_c1.{objectified}c2" )
        self.assertEqual(root.obj_c1.c2.text, path.find(root).text)
        path = objectify.ObjectPath( "root.obj_c1.{otherNS}c2" )
        self.assertEqual(getattr(root.obj_c1, '{otherNS}c2').text,
                          path.find(root).text)
    ...
    def test_object_path_ns_list(self):
        ...
        self.assertEqual(root.obj_c1.c2[2].text, path.find(root).text)
    ...
    def test_object_path_set(self):
        ...
        self.assertEqual(new_value, root.obj_c1.c2.text)
    ...
    def test_object_path_set_element(self):
        ...
        self.assertEqual("ATTR", root.obj_c1.c2.get("myattr"))
        self.assertEqual("TEST", root.obj_c1.c2.a.text)
    ...
    def test_object_path_set_create(self):
        ...
        self.assertEqual(1, len(root.obj_c1.c99))
        self.assertEqual(new_value, root.obj_c1.c99.text)
        self.assertEqual(new_value, path(root).text)
    ...
    def test_object_path_set_create_element(self):
        ...
        self.assertEqual(1, len(root.obj_c1.c99))
        self.assertEqual("ATTR", root.obj_c1.c99.get("myattr"))
        self.assertEqual("TEST", root.obj_c1.c99.a.text)
        self.assertEqual("TEST", path(root).a.text)
    ...
    def test_object_path_set_create_list(self):
        ...
        self.assertEqual(2, len(root.obj_c1.c99))
        self.assertEqual("ATTR1", root.obj_c1.c99[0].get("myattr"))
        self.assertEqual("TEST1", root.obj_c1.c99[0].text)
        self.assertEqual("ATTR2", root.obj_c1.c99[1].get("myattr"))
        self.assertEqual("TEST2", root.obj_c1.c99[1].text)
    ...
    def test_object_path_addattr(self):
        ...
        self.assertEqual(["0", "1", "2", "test"],
                          [el.text for el in root.obj_c1.c2])
    ...
    def test_object_path_addattr_element(self):
        ...
        self.assertEqual(4, len(root.obj_c1.c2))
        self.assertEqual("TEST", root.obj_c1.c2[3].a.text)
        self.assertEqual(["0", "1", "2"],
                          [el.text for el in root.obj_c1.c2[:3]])
    ...
    def test_object_path_addattr_create_list(self):
        ...
        self.assertEqual(2, len(root.obj_c1.c99))
        self.assertEqual("TEST1", root.obj_c1.c99.text)
        self.assertEqual("TEST2", path(root)[1].text)

    def test_descendant_paths(self):
        root = self.XML(xml_str)
        self.assertEqual(
            ['{objectified}root', '{objectified}root.obj_c1',
             '{objectified}root.obj_c1.c2',
             '{objectified}root.obj_c1.c2[1]', '{objectified}root.obj_c1.c2[2]',
             '{objectified}root.obj_c1.{otherNS}c2', '{objectified}root.obj_c1.{}c2'],
    ...
    def test_descendant_paths_prefix(self):
        ...
        self.assertEqual(
            ...
            root.obj_c1.descendantpaths('root'))
